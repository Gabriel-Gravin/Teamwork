...
- two different types of platforms like in doodle jump: 
- normal: where the player can jump on the platform forever as long as they don't die 
- breaking: platform will disappear after its jumped on once