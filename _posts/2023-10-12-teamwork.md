...
<body>
    ...
    <script>
        ...
        let isJumping = false;
        let isOnGround = false; // Variable to track if the sprite is on the ground
        let frameX = 0;
        let frameY = 0;
        let maxFrame = 2;
        ...
        function jump() {
            if (!isJumping && isOnGround) { // Check if it's on the ground before jumping
            ...
            function checkCollisions() {
                platforms.forEach(function (platform) {
                    if (
                        ...
                        isJumping = false;
                        spriteVelocityY = 0;
                        isOnGround = true; // Set the sprite on the ground
                    }
                });
            }
